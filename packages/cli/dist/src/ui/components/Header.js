...
import { grokShortAsciiLogo, grokLongAsciiLogo } from './AsciiArt.js';
import { getAsciiArtWidth } from '../utils/textUtils.js';
export const Header = ({ customAsciiArt, terminalWidth, }) => {
    let displayTitle;
    const widthOfLongLogo = getAsciiArtWidth(grokLongAsciiLogo);
    if (customAsciiArt) {
        ...
        // Use Grok branding
        displayTitle =
            terminalWidth >= widthOfLongLogo ? grokLongAsciiLogo : grokShortAsciiLogo;
    }
