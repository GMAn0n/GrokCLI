...
import { GrokConfig, loadServerHierarchicalMemory, setGrokMdFilename as setServerGrokMdFilename, getCurrentGrokMdFilename, ApprovalMode, DEFAULT_GROK_MODEL, DEFAULT_GROK_EMBEDDING_MODEL, FileDiscoveryService, } from '@grok/grok-cli-core';
...
async function parseArguments() {
    const yargsInstance = yargs(hideBin(process.argv))
        .scriptName('grok')
        .usage('$0 [options]', 'Grok CLI - Launch an interactive CLI, use -p/--prompt for non-interactive mode')
        .option('model', {
        alias: 'm',
        type: 'string',
        description: `Model`,
