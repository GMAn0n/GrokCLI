...
import { GrokConfig, GeminiClient, ToolRegistry } from '@grok/grok-cli-core';
import { GenerateContentResponse, Part, FunctionCall } from '@google/genai';

// Mock dependencies
vi.mock('@grok/grok-cli-core', async () => {
  const actualCore = await vi.importActual<
    typeof import('@grok/grok-cli-core')
  >('@grok/grok-cli-core');
  return {
    ...actualCore,
    GeminiClient: vi.fn(),
...
describe('runNonInteractive', () => {
  ...
  beforeEach(() => {
    ...
    mockConfig = {
      ...
      getGrokClient: vi.fn().mockReturnValue(mockGeminiClient),
      getContentGeneratorConfig: vi.fn().mockReturnValue({}),
      getMaxSessionTurns: vi.fn().mockReturnValue(10),
      initialize: vi.fn(),
    } as unknown as GrokConfig;
