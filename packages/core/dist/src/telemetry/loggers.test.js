...
describe('loggers', () => {
    ...
    describe('logUserPrompt', () => {
        ...
        it('should log a user prompt', () => {
            const event = new UserPromptEvent(11, 'prompt-id-8', AuthType.USE_GROK, 'test-prompt');
    ...
    describe('logApiResponse', () => {
        ...
        it('should log an API response with all fields', () => {
            ...
            const event = new ApiResponseEvent('test-model', 100, 'prompt-id-1', AuthType.OAUTH, usageData, 'test-response');
        ...
        it('should log an API response with an error', () => {
            ...
            const event = new ApiResponseEvent('test-model', 100, 'prompt-id-1', AuthType.USE_GROK, usageData, 'test-response', 'test-error');
            logApiResponse(mockConfig, event);
            expect(mockLogger.emit).toHaveBeenCalledWith({
                body: 'API response from test-model. Status: 200. Duration: 100ms.',
                attributes: {
