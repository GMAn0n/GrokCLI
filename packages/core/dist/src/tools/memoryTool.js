...
export const DEFAULT_GROK_CONTEXT_FILENAME = 'GROK.md';
export const MEMORY_SECTION_HEADER = '## Gemini Added Memories';
export const GROK_MEMORY_SECTION_HEADER = '## Grok Added Memories';
...
// It defaults to DEFAULT_GROK_CONTEXT_FILENAME but can be overridden by setGrokMdFilename.
let currentGrokMdFilename = DEFAULT_GROK_CONTEXT_FILENAME;
...
export function setGrokMdFilename(newFilename) {
    if (Array.isArray(newFilename)) {
        if (newFilename.length > 0) {
...
export function getCurrentGrokMdFilename() {
...
export function getAllGrokMdFilenames() {
    if (Array.isArray(currentGrokMdFilename)) {
        return currentGrokMdFilename;
    }
    return [currentGrokMdFilename];
